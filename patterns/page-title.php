...
/**
 * Title: Page Title
 * Slug: ultracare/page-title
 * Categories: ultracare, page-title
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() . '/images/inner-banner.jpg'); ?>","id":6,"dimRatio":50,"minHeight":300,"isDark":false} -->
